...
! function (t, e) {
    ...
    function l(o) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            "function" == typeof Object.getOwnPropertySymbols && (
                e = e.concat(Object.getOwnPropertySymbols(r).filter(function (t) {
                    return Object
            ...
            for (var i in n) 
                if (Object.prototype.hasOwnProperty.call(n, i)) {
                    ...
                    if (!new RegExp(o).test(s)) 
                        throw new Error(
                            t.toUpperCase() + ': Option "' + i + '" provided type "' + s + '" but expected ' +
                            'type "' + o + '".'
                        )
                }
            var a
    ...
    var v = "button",
        ...
        P = function () {
            ...
            return t.toggle = function () {
                ...
                e && this
                    ._element
                    .setAttribute("aria-pressed", !this._element.classList.contains(S)),
    ...
    var L = "carousel",
        ...
        lt = function () {
            ...
            t.nextWhenVisible = function () {
                !document.hidden && g(this._element).is(":visible") && "hidden" !== g(
                    this._element
            ...
            t.pause = function (t) {
                ...
                this
                    ._element
                    .querySelector(it) && (_.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            t._addEventListeners = function () {
                ...
                "hover" === this._config.pause && g(this._element)
                    .on(
                        Q.MOUSEENTER,
                        function (t) {
                            return e.pause(t)
            ...
            t._getItemIndex = function (t) {
                return this._items = t && t.parentNode
                    ? []
                        .slice
                        .call(t.parentNode.querySelectorAll(et))
                    : [],
                this
                    ._items
                    .indexOf(t)
        ...
        bt = function () {
            ...
            t.show = function () {
                ...
                if (!this._isTransitioning && !g(this._element).hasClass(mt) && (
                    this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Tt)).filter(function (t) {
                    ...
                    if (g(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        this
                            ._element
                            .style[o] = 0,
                        this._triggerArray.length && g(this._triggerArray)
                            .removeClass(yt)
                        ...
                        if (0 < i) 
                            for (var o = 0; o < i; o++) {
                                var r = this._triggerArray[o],
                                    s = _.getSelectorFromElement(r);
                                if (null !== s) 
                                    g([].slice.call(document.querySelectorAll(s))).hasClass(mt) || g(r)
                                        .addClass(
                                            yt
                                        )
            ...
            t._getDimension = function () {
                return g(this._element).hasClass(Et)
                    ? Et
                    : Ct
            },
                ...
                if (!this._element.disabled && !g(this._element).hasClass(Pt)) {
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (g(t).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === g(t)
                                .closest(Mt)
                                .length && g(document.body)
                                .children()
                ...
                return this.each(function () {
                    ...
                    if (t || (t = new c(
                        ...
                        "object" == typeof e
                            ? e
                            : null
                    ), g(this).data(Dt, t)), "string" == typeof e) {
        ...
        ve = function () {
            ...
            t._enforceFocus = function () {
                ...
                g(document)
                    ...
                    .on(re.FOCUSIN, function (t) {
                        document !== t.target && e._element !== t.target && 0 === g(e._element)
                            .has(
                                t.target
                            )
                            .length && e
            ...
            t._setScrollbar = function () {
                ...
                if (this._isBodyOverflowing) {
                    var t = []
                            .slice
                            .call(document.querySelectorAll(me)),
                        e = []
                            .slice
                            .call(document.querySelectorAll(pe));
    ...
    var be = "tooltip",
        ...
        Le = {
            animation: !0,
            template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="toolt' +
                    'ip-inner"></div></div>',
            trigger: "hover focus",
            title: "",
            delay: 0,
        ...
        Be = function () {
            ...
            t.dispose = function () {
                ...
                (this._activeTrigger = null) !== this._popper && this
                    ._popper
                    .destroy(),
                this._popper = null,
                this.element = null,
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var s = "function" == typeof this.config.placement
                            ? this
                                .config
                                .placement
                                .call(this, o, this.element)
                            : this.config.placement,
                        a = this._getAttachment(s);
                    this.addAttachmentClass(a);
                    var l = this._getContainer();
                    g(o).data(this.constructor.DATA_KEY, this),
                    g.contains(this.element.ownerDocument.documentElement, this.tip) || g(o).appendTo(
                        l
                    ),
                    ...
                    g(o).addClass(Fe),
                    "ontouchstart" in document.documentElement && g(document.body)
                        .children()
                        .on("mouseover", null, g.noop);
                    var c = function () {
            ...
            t.hide = function (t) {
                var e = this,
                    ...
                    o = function () {
                        e._hoverState !== je && n.parentNode && n
                            .parentNode
                            .removeChild(n),
                        e._cleanTipClass(),
                        e
    ...
    var Ve = "popover",
        ...
        Je = l({}, Be.Default, {
            ...
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popove' +
                    'r-header"></h3><div class="popover-body"></div></div>'
        }),
        ...
        sn = function (t) {
            ...
            o._getContent = function () {
                return this
                    .element
                    .getAttribute("data-content") || this.config.content
            },
        ...
        Dn = function () {
            function n(t, e) {
                ...
                this._scrollElement = "BODY" === t.tagName
                    ...
                    : t,
                this._config = this._getConfig(e),
                this._selector = this._config.target + " " + vn + "," + this._config.target +
                        " " + En + "," + this._config.target + " " + Tn,
                this._offsets = [],
                this._targets = [],
    ...
    function () {
        if ("undefined" == typeof g) 
            throw new TypeError(
                "Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstr" +
                "ap's JavaScript."
            );
        var t = g
            .fn
